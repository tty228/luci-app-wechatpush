...
return view.extend({
	render: function (data) {
		...
		o.description = _("The restart operation will be performed after a network disconnection of ten minutes and will be attempted a maximum of two times.<br/>【!!This feature cannot guarantee compatibility!!】")
		o.depends('unattended_enable', '1');
